...
// circomlib import
include "../../utils/stdlib/comparators.circom";
// zk-kit import
include "../../utils/zk-kit/unpack-element.circom";
// local imports
...
template TallyVotesNonQv(
    ...
    sbCommitment <== computedSbCommitment;
    ...
    // Verifies the updated results and spent credits, ensuring consistency and correctness of tally updates.
     var (computedCurrentTallyCommitment, computedNewTallyCommitment) = ResultCommitmentVerifierNonQv(voteOptionTreeDepth)(
    ...
    currentTallyCommitment <== computedCurrentTallyCommitment;
    newTallyCommitment <== computedNewTallyCommitment;
}

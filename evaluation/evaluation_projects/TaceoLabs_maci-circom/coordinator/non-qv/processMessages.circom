...
// circomlib import
include "../../utils/stdlib/mux1.circom";
// zk-kit imports
include "../../utils/zk-kit/safe-comparators.circom";
// local imports
 ...
 */
 template ProcessMessagesNonQv(
    ...
    signal output coordinatorPublicKeyHash;
    ...
    currentSbCommitment <== computedCurrentSbCommitment;
    ...
    outputBatchHash <== chainHash[batchSize];
    ...
    coordinatorPublicKeyHash <== derivedPubKeyHash;
    ...
    newSbCommitment <== computedNewSbCommitment;
}

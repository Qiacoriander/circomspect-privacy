...
template VerifyPrivateTransfer() {
    ...
    component check3 = GreaterEqThan(32);
    check3.in[0] <== balance;
    check3.in[1] <== amount;
    ...
    component tmpEq1 = IsEqual();
    tmpEq1.in[0] <== check1.isEqual;
    tmpEq1.in[1] <==  check2.isEqual;
    
    component tmpEq2 = IsEqual();
    tmpEq2.in[0] <== tmpEq1.out;
    tmpEq2.in[1] <== check4.isMatch;
